								...
								<table width="452" height="290" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td align="center" valign="bottom" background="${pageContext.request.contextPath}/images/loginbg.gif">
											<form id="loginAction_home" name="form1" action="/user/login" target="_parent" method="post">
												<table border="0" align="center" cellpadding="2" cellspacing="0">
													...
													<tr>
														<td height="30" nowrap>
															<font color="000F60"><strong>用户id：</strong> </font>
														</td>
														<td>
															<input type="text" name="id" value="" id="id" class="text" style="width: 160px;"/>
														</td>
													</tr>
													<tr>
														<td height="30" nowrap>
														...
														<td>
															<input type="password" name="password" id="password" class="text" style="width: 160px;"/>
														</td>
													</tr>
													<tr>
